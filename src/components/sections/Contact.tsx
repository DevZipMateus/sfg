...
const Contact = () => {
  ...
  return (
    <section ref={sectionRef} id="contact" className="bg-white py-0">
      <div className="section-container">
        ...
        >
          ...
          <p className="section-subtitle">
            Estamos prontos para atender às suas necessidades contábeis. Entre em contato através de um dos nossos canais de atendimento ou nos envie uma mensagem pelo WhatsApp.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          >
            <div className="w-full max-w-md p-8 rounded-xl shadow-lg bg-white border border-slate-100">
              <h3 className="text-2xl font-bold text-slate-900 mb-6 text-center">Fale Conosco</h3>
              ...
              <Button 
                ...
                className="w-full py-6 text-lg gap-2 bg-green-500 hover:bg-green-600"
              >
