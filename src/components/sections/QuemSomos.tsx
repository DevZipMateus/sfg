...
const QuemSomos = () => {
  ...
  return <section ref={sectionRef} id="quem-somos" className="bg-white py-0">
      <div className="container-section">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <motion.div className="relative h-64 md:h-auto min-h-[300px] bg-gray-100 rounded-lg overflow-hidden" initial={{
          opacity: 0,
          x: 20
        }} animate={isVisible ? {
          opacity: 1,
          ...
          delay: 0.4
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <img src="/lovable-uploads/f111a145-a104-4307-82de-967555758e14.png" alt="SFG Correias e Mangueiras" className="max-w-full max-h-full p-8" width="300" height="200" />
            </div>
          </motion.div>
        </div>

        <motion.div className="bg-gray-100 p-6 rounded-lg mb-12" initial={{
        opacity: 0,
        y: 20
      }} animate={isVisible ? {
        opacity: 1,
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {diferenciais.map((item, index) => <motion.div key={index} className="card p-6 text-center" initial={{
          opacity: 0,
          y: 20
        }} animate={isVisible ? {
          opacity: 1,
